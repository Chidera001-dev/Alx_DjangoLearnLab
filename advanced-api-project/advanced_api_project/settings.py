...
SECRET_KEY = 'django-insecure--dy-amb&rj=8hf$krni_ya!$1#vm_bj3j3v*z17#_yb1&jjl55'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # keep this if you still want admin login
    ],
